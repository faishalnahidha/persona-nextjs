        ...
        <div className="mx-auto grid grid-cols-1 lg:grid-cols-[3fr_2fr] justify-start lg:justify-center gap-4 md:gap-6 xl:gap-10 px-6 md:px-10 pt-24 pb-10 lg:py-0">
          ...
          <div className="flex flex-col items-stretch justify-center gap-4 lg:gap-6">
            <div className="flex flex-col gap-4 lg:gap-6">
              <h1 className="text-4xl/10 lg:text-6xl/16 font-semibold lg:font-medium text-foreground">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-3 gap-2 min-h-48 mt-2 lg:mt-4 pr-0 2xl:pr-20">
              {/* Cards #1*/}
              ...
              {/* Cards #3*/}
              <div className="col-span-2 xl:col-span-1 flex flex-row lg:flex-col w-full h-full rounded-2xl bg-brand-neutral-200 p-4 ">
                <div className="flex flex-row lg:flex-col items-start justify-center gap-2 lg:gap-0">
                  <div className="text-4xl/11 lg:text-5xl font-heading font-medium text-brand-neutral-500">
                    500+
                  </div>
                ...
                <div className="flex flex-1 items-end justify-end">
                  <IconFileTextSpark className="size-12 lg:size-16 text-brand-neutral-400" stroke={1.5} />
                </div>
              </div>
            </div>
          </div>
